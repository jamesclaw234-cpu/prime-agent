...
- Documented that lot-step dust, not the fee, is the dominant cost of a small cycle: roughly half a `stepSize` per intermediate asset per cycle, which is about 68bps on a $100 cycle and about 0.7bps on a $10,000 one.
